...
ChatLogTopBar.InputChanged:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then CLDragInput = input end
end)
UserInputService.InputChanged:Connect(function(input)
...
getgenv().ToxEnv = {
    ...
    StartFlyCar = StartFlyCar, StopFlyCar = StopFlyCar,
    StartNoclip = StartNoclip, DisableNoclip = DisableNoclip,
